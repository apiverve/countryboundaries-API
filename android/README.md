# Country Boundaries Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:countryboundaries-api:1.1.12'
}
```
...
```java
import com.apiverve.countryboundaries.CountryBoundariesAPIClient;
import com.apiverve.countryboundaries.APIResponse;
import com.apiverve.countryboundaries.APIException;

// Initialize the client
CountryBoundariesAPIClient client = new CountryBoundariesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countryboundaries](https://docs.apiverve.com/ref/countryboundaries)
...
- **Documentation:** [https://docs.apiverve.com/ref/countryboundaries](https://docs.apiverve.com/ref/countryboundaries)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countryboundaries-api/issues)
