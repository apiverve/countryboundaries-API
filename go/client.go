// Package countryboundaries provides a Go client for the Country Boundaries API.
//
// For more information, visit: https://apiverve.com/marketplace/countryboundaries?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/countryboundaries"
	defaultTimeout = 30 * time.Second
)

// Client is the Country Boundaries API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Country Boundaries API client.
...
// Execute makes a request to the Country Boundaries API with typed parameters.
//
