...
namespace APIVerve\Countryboundaries;

use GuzzleHttp\Client as HttpClient;
use GuzzleHttp\Exception\GuzzleException;
use APIVerve\Countryboundaries\Exceptions\APIException;
use APIVerve\Countryboundaries\Exceptions\ValidationException;

/**
 * Client for the Country Boundaries API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/countryboundaries?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countryboundaries';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountryboundariesClient] {$message}\n";
        }
    }
}
